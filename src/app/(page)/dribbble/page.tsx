...
const Navbar = () => {
  return (
    <div className='flex px-10 items-center py-4 gap-4'>
      ...
      <div className='flex gap-6 font-medium p-6 flex-1 items-center justify-start'>
...
const Hero = () => {
  return (
    <div className='h-screen w-screen flex flex-col justify-center items-center space-y-10'>
      ...
      <button className='p-3 font-bold rounded-full bg-black text-white hover:bg-opacity-60'>Start hiring today</button>
    </div>
  )
}
const Content = () => {
  return (
    <div className='px-20'>
      ...
      <div className='flex gap-10 '>
        <p className='px-10 flex-1 text-7xl font-serif'>When only the best talent will do</p>
        <div className='space-y-10 flex-1'>
          <p className='text-2xl'>From Ford to Airbnb to Capital One, see why over 60,000 leading brands and business builders use Dribbble to attract, engage, and hire their best design talent.</p>
          <button className='p-3 font-bold rounded-full bg-black text-white hover:bg-opacity-60'>Get started</button>
        </div>
      </div>
      {/* Secon section */}
      <div className='w-full h-screen flex flex-col justify-center items-center space-y-10'>
        <p className='px-2 py-1 shadow-sm text-xl rounded-full bg-dribbbleContent font-medium '> Trusted by top brands & businesses</p>
        <p className='text-7xl font-medium w-2/3 mx-auto text-center font-serif'>Connecting brands and business builders with the world is top designers</p>
        <p className='text-xl font-medium font-sans w-2/3 text-center'>The world is leading brands use Dribbble to hire creative talent. Browse millions of top-rated portfolios to find your perfect creative match.</p>
      </div>
      {/* three section */}
      <div className='flex'>
