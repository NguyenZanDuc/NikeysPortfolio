...
export default page
//https://theplannersvn.com/wp-content/uploads/2022/04/mainlogo-tp-01.svg
const Navbar = () => {
    return (
        ...
        <div className='relative'>
            ...
            <div className='w-[80%] md:h-[400px] bg-white z-10 absolute top-full right-1/2 flex gap-10  -translate-y-1/4 translate-x-1/2 md:p-16 p-4'>
                ...
                <div className='flex-1 space-y-8'>
                    <p className='text-md'>Là một trong những wedding planner cao cấp và chuyên nghiệp nhất tại Việt Nam, The Planners cung cấp dịch vụ tư vấn, lập kế hoạch, thiết kế và tổ chức lễ cưới trọn gói tới các khách hàng trong nước và quốc tế tại nhiều địa điểm xuyên suốt Việt Nam. Với dịch vụ cao cấp thiết kế dựa trên yêu cầu cụ thể của từng khách hàng, mỗi đám cưới do The Planners tổ chức luôn đẹp, độc đáo và đáng nhớ không chỉ với các cặp đôi mà còn để lại ấn tượng sâu sắc với các khách mời.</p>
                    <button className='rounded-sm text-white px-3 py-2 relative bg-thePlanner group w-[140px]  hover:w-[150px] duration-300 overflow-hidden flex justify-start items-center '>
...
const Service = () => {
    return (
        <div className='md:h-[600px]  bg-thePlannerBackground w-full md:pt-[320px] pt-[230px]'>
            <div className='md:space-y-10 space-y-5'>
                ...
                <div className='flex justify-center gap-20 divide-x-2 md:text-5xl text-xl'>
                    <p className='w-[300px] text-center cursor-pointer'>Wedding Planning</p>
                    <p className='w-[300px] text-center cursor-pointer'>Destination Wedding</p>
                    <p className='w-[300px] text-center cursor-pointer'>Styling & Decoration</p>
                </div>
            </div>
        </div>
    )
            ...
            <div className='w-screen flex flex-col md:flex-row-reverse gap-4 md:p-[200px] p-4'>
                <div className='flex-1'>
                    <div className='p-10  space-y-4'>
                        ...
                        <button className='rounded-sm text-white px-3 py-2 relative bg-thePlanner group w-[190px]  hover:w-[210px] duration-300 overflow-hidden flex justify-start items-center '>
