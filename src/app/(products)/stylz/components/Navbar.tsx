  ...
  return (
    <AnimatePresence>
      ...
      <motion.div
       ...
       className='fixed top-0  left-0 bg-opacity-80 text-xl md:text-5xl w-screen h-screen flex-col z-40 bg-black flex items-start justify-center md:gap-10 gap-4 p-10'>
        <InView delay={0.3}>
        ...
        <div 
        onClick={onClose}
        className='absolute top-5 left-5 text-3xl text-white z-50 cursor-pointer'>
        X
      </div>
      </motion.div>
      }
