...
const page = (props: Props) => {
    return (
        <div className=''>
            <div className='md:p-32 p-4 space-y-4 md:space-y-8'>
                <InView className='md:text-6xl text-2xl text-center font-bold'>Visit Us</InView>
                <InView delay={0.2} className='text-xl md:w-1/2 mx-auto text-center text-gray-400'>Discover a world of beauty and relaxation at our salon. Experience top-notch hair, skin, and nail care services in a welcoming and luxurious environment.</InView>
            </div>
            <Content />
            <div className='p-4'>
