        ...
        <div className='px-32'>
            <div className='flex'>
                <div className='flex-1 space-y-6'>
                    ...
                    <p className='text-6xl font-semibold'>Leading global technical service provider</p>
                    <p className='text-gray-500'>We harness the power of the latest technological to provide you with solutions that propel your business.</p>
                ...
                <div className='flex-1 p-20'>
                    <Image src={'https://framerusercontent.com/images/cG6ARQcLGLjGOFfE0MVUM2w1smQ.png?scale-down-to=512'} alt={''} width={1000} height={1000} style={{ width: "80%", height: "100%" }} />
                </div>
            </div>
            <div>
                <p className='font-semibold'>Over 32K+ technical service growing with TechPro</p>
                {/* <div>
                    <Image src={''} alt={''} width={1000} height={1000} style={{width:"100%", height:"100%"}} />
                    <Image src={''} alt={''} width={1000} height={1000} style={{width:"100%", height:"100%"}} />
                    <Image src={''} alt={''} width={1000} height={1000} style={{width:"100%", height:"100%"}} />
                    <Image src={''} alt={''} width={1000} height={1000} style={{width:"100%", height:"100%"}} />
                    <Image src={''} alt={''} width={1000} height={1000} style={{width:"100%", height:"100%"}} />
...
const ServiceCard = ({ icon, title, description }: ServiceCardProps) => {
    return (
        <div className='w-[360px] p-4 rounded-md bg-white space-y-5'>
        ...
        <div className='p-32 space-y-10'>
            ...
            <div className='flex gap-10'>
                ...
                <div className='flex-1 space-y-5 text-lg'>
                    <p >About us</p>
                    <p className='text-3xl font-semibold'>World leading technical company since 1997</p>
                    <p className='text-gray-500'>Our mission was clear - to empower businesses and individuals with cutting-edge technology solutions that would transform the way they operate, communicate, and thrive in the digital age.</p>
            ...
            <div className='flex flex-row-reverse gap-10'>
                ...
                <div className='flex-1 space-y-5 text-lg'>
                    <p >What we offer</p>
                    <p className='text-3xl font-semibold'>Experience backed by our expertise at your service</p>
                    <p className='text-gray-500'>Throughout our journey, [Company Name] has achieved numerous milestones that reflect our unwavering dedication to technical excellence.</p>
                    {/* items */}
                    <div className='flex gap-3'>
                        <div>
                            Icon
            ...
            <div className='space-y-5'>
                ...
                <p className='text-center text-4xl w-1/2 mx-auto font-semibold'>Kind words from customers around the world</p>
