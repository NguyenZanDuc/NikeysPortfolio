...
const Hero = () => {
    return (
        <div className='w-screen bg-consulyText relative z-10 text-white flex justify-center flex-col gap-5 items-center p-32'>
            ...
            <p className='w-1/2 text-center'>Our collaborative approach fosters strong partnerships with our clients, ensuring that we truly understand your business and its potential.</p>
        </div>
    )
}
const Content = () => {
    return (
        <div className='w-screen h-screen flex justify-center items-center flex-col gap-10'>
            <p className='text-6xl'>The story behind our agency start</p>
            ...
            <div className=' overflow-hidden space-x-8'>
...
const Data = () => {
    return (
        <div className='p-20 w-screen flex justify-center gap-6'>
            <CardData />
            <CardData />
            <CardData />
        </div>
...
const Team = () => {
    return (
        <div className='container mx-auto flex flex-col items-center gap-10 p-10'>
            <p className='p-2 rounded-full inline text-consulyText bg-consulyContent text-lg'>Case Studies</p>
            <p className='w-1/4 text-5xl text-center'>Meet Our Leadership</p>
            ...
            <p className='text-xl text-gray-500 font-semibold'>Interset About knowing More About Us?  
...
const CardMember = () => {
    return (
        <div className='max-w-[200px] space-y-3 relative overflow-hidden cursor-pointer group'>
